...
<head>
  <meta charset="utf-8">
  <title>Cinemaghar-Homepage</title>
  ...
  <body>
    <header>
        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            ...
            <span class="navbar-text">Cinemaghar</span>
  ...
  <footer class="page-footer font-small blue">
    ...
    <div class="footer-copyright text-center py-3">BIKRAM SAH © 2024 All rights reserved:
      <a href="">info@sahbikram.com.np</a>
    </div>
